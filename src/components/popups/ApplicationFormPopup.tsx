...
const ApplicationFormPopup: FC<{
  ...
  return (
    <div className="absolute top-0">
      ...
      <div
        className={
          "shadow bg-primary z-40 fixed flex flex-col select-none rounded z-20 w-1/2 top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/3 min-w-planAdd shadow"
        }
      >
