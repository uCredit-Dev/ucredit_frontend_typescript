...
const PlanAdd: FC = () => {
  ...
  return (
    <div className="absolute top-0">
      ...
      <div
        className={
          "z-40 fixed flex flex-col bg-gradient-to-r shadow from-blue-500 to-green-400 select-none rounded z-20 h-auto w-3/12 top-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/3 min-w-planAdd"
        }
      >
