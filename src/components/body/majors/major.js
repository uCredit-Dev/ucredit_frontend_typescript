...
const bsChemBE = {
  ...
  distributions: [
    ...
    },
    {
      ...
      required: 16,
      filter: {
        number: /(?=.*EN\.030\.205)(?=.*EN\.020\.305)(?=.*EN\.030\.307)(?=.*EN\.030\.452).*/g.toString(),
      }
    },
    {
    ...
    },
    {
      ...
      required: 39,
      filter: {
        number: /(?=.*EN\.540\.101)(?=.*EN\.540\.202)(?=.*EN\.540\.203)(?=.*EN\.540\.301)(?=.*EN\.540\.303)(?=.*EN\.540\.304)(?=.*EN\.540\.305)(?=.*EN\.540\.306)(?=.*EN\.540\.311)(?=.*EN\.540\.314)(?=.*EN\.540\.315)(?=.*EN\.540\.409)(?=.*EN\.540\.490).*/g.toString(),
      },
    },
    {
  ...
  requirments: [
    {
      ...
      byCredit: false,
      filter: {
        number: /(?=.*EN\.030\.101)(?=.*EN\.030\.102)(?=.*EN\.030\.105)(?=.*EN\.030\.106)(?=.*EN\.171\.101)(?=.*EN\.171\.102)(?=.*EN\.173\.111).*/g.toString(),
    },
    {
      name: "Mathematics",
      required: 4,
      byCredit: false,
      filter: {
        number: /(?=.*EN\.110\.108)(?=.*EN\.110\.109)(?=.*EN\.110\.202)(?=.*EN\.110\.302).*/g.toString(),
      },
    },
    {
      name: "Advanced Chemistry/Biology",
  ...
  requirments: [
    {
      ...
      byCredit: false,
      filter: {
        number: /(?=.*AS\.110\.108)(?=.*AS\.110\.109|AS\.110\.113)(?=.*AS\.110\.202|AS\.110\.211).*/g.toString(),
      },
    },
    {
      name: "Linear Algebra",
    ...
    },
    {
      ...
      filter: {
        ...
        number: /EN\.500\.11[2-4]|AS\.250\.205|EN\.553\.281|EN\.580\.244|EN\.601\.220/g.toString(),
      },
    },
    {
    ...
    },
    {
      ...
      byCredit: false,
      filter: {
        number: /EN\.553\.171|EN\.553\.172|EN\.553\.371|EN\.553\.471|EN\.553\.472/g.toString(),
      },
    },
    {
      ...
      byCredit: false,
      filter: {
        number: /(?=.*EN\.553\.420)(?=.*EN\.553\.430|EN\.553\.431).*/g.toString(),
      },
    },
    {
      name: "Optimization",
    ...
    //take a look at the catagories
    {
      ...
      sameCatagory: true,
      filter: {
        number: [/AS\.110\.405|AS\.110\.445|EN\.553\.426|EN\.553\.427|EN\.553\.433|EN\.553\.492/g.toString, /AS\.110\.445|EN\.553\.400|EN\.553\.413|EN\.553\.414|EN\.553\.416|EN\.553\.417|EN\.553\.432|EN\.553\.433|EN\.553\.492/g.toString, /AS\.110\.445|EN\.553\.400|EN\.553\.413|EN\.553\.414|EN\.553\.416|EN\.553\.417|EN\.553\.432|EN\.553\.433|EN\.553\.436|EN\.553\.439|EN\.553\.450/g.toString, /EN\.553\.362|EN\.553\.400|EN\.553\.453|EN\.553\.463|EN\.553\.465|EN\.553\.467/g.toString, /AS\.110\.401|EN\.553\.371|EN\.553\.463|EN\.553\.471|EN\.553\.472/g.toString, /EN\.553\.427|EN\.553\.428|EN\.553\.441|EN\.553\.442|EN\.553\.444|EN\.553\.445|EN\.553\.447|EN\.553\.448|EN\.553\.449|EN\.553\.488/g.toString, /(?=.*EN\.553\.481)(?=.*AS\.110\.445|EN\.553\.433|EN\.553\.467|EN\.553\.493).*/g.toString()],
    ...
    },
    {
      ...
      byCredit: false,
      filter: {
        number: /AS\.110\.445|EN\.553\.400|EN\.553\.413|EN\.553\.416|EN\.553\.417|EN\.553\.432|EN\.553\.433|EN\.553\.436|EN\.553\.443|EN\.553\.450|EN\.553\.463|EN\.553\.467|EN\.553\.481|EN\.553\.488|EN\.553\.493|EN\.553\.494|EN\.601\.433|EN\.601\.475|EN\.601\.482/g.toString(),
      },
    },
    {
...
const baEconomics = {
  ...
  requirments: [
    ...
    },
    {
      ...
      byCredit: false,
      filter: {
        number: /AS\.280\.345|EN\.553\.111|EN\.553\.112|EN\.553\.113|EN\.553\.211|EN\.553\.310|EN\.553\.311|EN\.553\.420|EN\.553\.430|EN\.553\.435|EN\.560\.348|EN\.560\.435/g.toString(),
      },
    },
  ],
};
...
const bsBME = {
  ...
  distributions: [
    ...
    },
    {
      ...
      required: 3,
      filter: {
        number: /EN\.600\.[0-9]{3}|EN\.601\.[0-9]{3}|EN\.500\.11[2-4]/.toString(), //"EN.601.***" or "EN.500.11*"
      },
    },
    {
      name: "Free Electives",
