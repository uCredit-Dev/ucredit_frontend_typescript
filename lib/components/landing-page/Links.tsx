...
const Links: React.FC = () => {
  ...
  return (
    ...
    <div className="font-landingPage grid grid-rows-5 grid-cols-3 grid-flow-col gap-4 items-stretch">
      <div className="row-start-1 row-end-2 col-span-4 text-gray text-center text-5xl">Open Source</div>
      <div className="px-48 row-span-1 col-span-4 text-center text-xl">
      ...
      <div className="row-span-2 col-span-1 pl-24 pt-5">
        <button className="px-12 py-5 mr-4 border-4 hover:text-blue-footer hover:bg-blue-header rounded-[50px] font-bold text-2xl">
          Github
        </button>
      </div>
