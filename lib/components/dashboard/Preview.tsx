...
const Preview: React.FC = () => {
  ...
  return (
    ...
    <div 
      className={clsx("fixed top-0 z-49 w-[100%] h-[100%] font-['Futura'] bg-slate-100 transition-all duration-500 ease-in-out", {
        "translate-y-full" : !showPreview
      })}
      onClick={togglePreview}> 
    </div>
    <div 
      className={clsx("fixed bottom-0 z-51 w-[100%] h-[70%] font-['Futura'] bg-white rounded-[20px] transition-all duration-500 ease-in-out", {
        "translate-y-full" : !showPreview
      })}> 
      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"
        onClick={togglePreview}
        className="absolute top-5 right-5">
        <path d="M9.4 8L15.7 1.7C16.1 1.3 16.1 0.7 15.7 0.3C15.3 -0.1 14.7 -0.1 14.3 0.3L8 6.6L1.7 0.3C1.3 -0.1 0.7 -0.1 0.3 0.3C-0.0999998 0.7 -0.0999998 1.3 0.3 1.7L6.6 8L0.3 14.3C0.1 14.5 0 14.7 0 15C0 15.6 0.4 16 1 16C1.3 16 1.5 15.9 1.7 15.7L8 9.4L14.3 15.7C14.5 15.9 14.7 16 15 16C15.3 16 15.5 15.9 15.7 15.7C16.1 15.3 16.1 14.7 15.7 14.3L9.4 8Z" fill="#797877"/>
      </svg>
