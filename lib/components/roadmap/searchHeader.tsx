      ...
      justify-center items-center text-lg text-blue-900">
        <a href="/">
          <div className="flex flex-row">
            ...
            <p className="hidden md:block text-xl flex-grow-0 mx-5 pt-0.5
            pb-1">
              uCredit
            </p>
          </div>
        ...
        <div className="hidden md:block flex-grow-0">
          <a href="/" className="mx-2 px-3 pb-0.5 underline rounded-3xl 
          hover:bg-blue-900 hover:text-white">
            Dashboard
          </a>
          <a href="/" className="mx-2 px-3 pb-0.5 rounded-3xl text-white 
          bg-blue-900">
            Search
          </a>
          <a href="/" className="ml-2 mr-5 px-3 pb-0.5 underline rounded-3xl 
          hover:bg-blue-900 hover:text-white">
            Post
          </a>
        </div>
